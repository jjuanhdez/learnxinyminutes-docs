---
language: Fortran 95
filename: learnfortran95-es.f95
contributors:
...
Fortran es uno de los lenguajes informáticos más antiguos. Fue desarrollado en 
la década de 1950 por IBM para cálculos numéricos (Fortran es una abreviatura 
de "Formula Translation"). A pesar de su antigüedad, sigue siendo utilizado 
para la informática de alto rendimiento como la predicción del tiempo. 
Sin embargo, el lenguaje ha cambiado considerablemente a lo largo de los años, 
aunque en su mayoría manteniendo la compatibilidad hacia atrás; bien 
conocidas son las versiones FORTRAN 77, Fortran 90, Fortran 95, Fortran 2003, 
Fortran 2008 y Fortran 2015.

Esta visión general discutirá las características de Fortran 95 ya que es de 
las especificaciones más recientes y las versiones posteriores son en gran 
medida similares (en comparación con FORTRAN 77 es un lenguaje muy diferente).
...
+ [wikipedia](https://es.wikipedia.org/wiki/Fortran)
...
+ [lista de tutoriales de Fortran 95](http://www.dmoz.org/Computers/Programming/Languages/Fortran/FAQs%2C_Help%2C_and_Tutorials/Fortran_90_and_95/)
+ [Fortran wikibook](https://en.wikibooks.org/wiki/Fortran)
+ [Recursos Fortran](http://www.fortranplus.co.uk/resources/fortran_resources.pdf)
+ [Errores en Fortran 90 Programas que podrían sorprenderte](http://www.cs.rpi.edu/~szymansk/OOF90/bugs.html)
